...
def train_agent(args: Config):
    ...
    evaluator = Evaluator(eval_env=build_env(args.env_class, args.env_args),
                          ...
                          cwd=args.cwd)
    with wandb.init(project="elegentrl.ppo.cyborg", name="12-6_elegentrl.ppo.cyborg.3layerMlp.RedMeanderAgent", dir="/home/zhx/word/DriverOrderOfflineRL/scripts/wandb", config=args):
    ...
    # for i in range(100):
        while True:  # start training
            ...
            if (evaluator.total_step % 10000):
                ...
                torch.save(agent.cri.state_dict(), f"{wandb.run.dir}/{int(evaluator.total_step / 2000)}critic.pth")
